...
public:
	...
	CLocalStereoMatching(const cv::Mat & imgL,const cv::Mat & imgR,
		...
		double validThreshold = 10, double curvThreshold = -1.5, double peakRatio = 1.2)://double validThreshold = 10, double curvThreshold = -1.5, double peakRatio = 1.2):
